...
--����
local ElongNoteHealthDrain = .02 --�з������Ŀ�Ѫǿ��(Easy�Ѷ�)
local EnoteHealthDrain = .025		--�з��������Ŀ�Ѫǿ��(Easy�Ѷ�)


local NlongNoteHealthDrain = .01 --�з������Ŀ�Ѫǿ��(Normal�Ѷ�)
local NnoteHealthDrain = .04		--�з��������Ŀ�Ѫǿ��(Normal�Ѷ�)
